...
## Roteiro detalhado (checklist)
    ...
    - [x] Java Object-Oriented Concept
      ...
      - [x] Local inner classes
    - [x] Java Object-Oriented Programming
      - [x] Inheritance
      - [x] Sealed Class
      - [x] Method Overriding
      - [x] super and this keywords
      - [x] final keyword
      - [x] abstract keyword
      - [x] Interface
      - [x] Polymorphism
    ...
    - [ ] Overview of Threads
        ...
        - [x] Thread x Processes
        - [x] Thread Manager
        - [x] Thread State and Monitoring
    - [x] Thread Creation and Management
    - [x] Synchronization and Concurrency Control
